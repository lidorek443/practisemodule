...
<div id="sample">
  ...
  <div>
    ...
    <p>The inspector code lies in <a href="DataInspector.js" target="_blank">DataInspector.js</a> and <a href="DataInspector.css">DataInspector.css</a>.
        This code is meant to be a starting point for making your own model data inspector.
    <p>On browsers that support it, color types display a color picker. There are various plugins and polyfills for this functionality

...
<div id="sample">
  ...
  <p>
    The remaining nodes and links are partitioned into separate subnetworks (also known as subgraphs) with no links between subnetworks.
    The <a>ArrangingLayout.primaryLayout</a> is performed on each subnetwork.
  </p>
  <p>
    If there is more than one subnetwork, those subnetworks are treated as if they were individual nodes and are
  ...
  <p>
    This extension layout is defined in its own file, as <a href="ArrangingLayout.ts" target="_blank">ArrangingLayout.ts</a>.
  </p>

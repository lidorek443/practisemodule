...
<body>
  ...
  <div id="sample">
    ...
    <p>
      To simulate mouse events the buttons below use the <b>Robot</b> class that is defined in <a href="Robot.js" target="_blank">Robot.js</a>.
    </p>
    <p>
  ...
  <script type="module" id="code">
    ...
    document.getElementById("pan").onclick = pan;

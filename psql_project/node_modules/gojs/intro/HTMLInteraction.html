...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> GoJS HTML Interaction -- Northwoods Software </title>
...
<p>
GoJS does not depend on jQuery, but the two can be used together. The <a href="../samples/htmlInteraction.html">HTML Interaction Sample</a> places a GoJS Palette inside of a jQuery movable window, and a data inspector that modifies the current selected node inside another.
...
<script>goCode("toolTipExample", 600, 160, "diagramParent")</script>
...
<script>goCode("textEditorExample", 600, 160, "diagramParent2")</script>

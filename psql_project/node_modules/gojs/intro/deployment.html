...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> GoJS Deployment -- Northwoods Software </title>
...
<p>
  ...
  <a href="../license.html">commercial license agreement</a>.
  It is not open-source.
  If you have downloaded a copy of the <b>GoJS</b> library from <a href="https://gojs.net">gojs.net</a> or npm or GitHub
  for use in your own app, you may have noticed that a watermark appears in the diagram.
  For version 1.8 and beyond, you need to use a license key to remove this watermark from your domain.
  For versions 1.7 and earlier, view the <a href="https://gojs.net/1.7.29/intro/deployment.html">1.7 documentation</a>.
</p>
<p>
  When you want to deploy to your own web site your app that uses <b>GoJS</b>, you will need to make a request at:
  <a href="https://nwoods.com/activate.html?sku=gojs" target="_blank">https://nwoods.com/activate.html?sku=gojs</a>.
</p>
<p>
  Enter your e-mail address and the e-mail address of the person who purchased a license for <b>GoJS</b>,
  the order number for that purchase, and your web site's domain name or your Electron app's <code>package.json</code> "name" attribute,
  or "productName" attribute if it is specified.
...
<p>
  ...
  The protocol (such as <code>https://</code>) and port number (such as <code>:8080</code>) do not matter, so do not include them.
</p>
<p>
  The license key will also work when the HTML page is served from a subdomain of the licensed domain,
  such as from <code>editors.example.com</code>.
  With any valid license key it will also work at the <code>localhost</code> domain, which is useful when debugging and testing.
</p>
<p>
  ...
  such as for downloading image files to show in <a>Picture</a> objects.
</p>
...
<pre class="lang-js"><code>// Must execute after loading the library and before you create your first Diagram:
...
<p>
  ...
  <code>go-debug.js</code>, or the ES module versions of the library, but only with GoJS version 1.8 or later.
...
<p>
  ...
  For example, a license key for version 1.8.3 will work for all versions 1.8.*.
...
<p>
  When building a desktop application using Electron, your HTML page is not being served from a web server at a domain.
  You will need to activate with the <code>"name"</code> you have specified in your project's <code>package.json</code>
...
<p>
  ...
  or if your app is hosted in a WebView as part of a desktop application,
  <a href="https://www.nwoods.com/contact.html">Contact sales</a> for our our Unlimited Domains option and instructions.
</p>
<p>
  When requesting a license key at <a href="https://nwoods.com/activate.html?sku=gojs" target="_blank">Activate</a>,
  you do not need to specify a domain name.
</p>
...
<p>
  ...
  The library does not contain any of its own icons (images) or cursors.
</p>
<p>

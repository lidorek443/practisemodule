...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> Extending GoJS -- Northwoods Software </title>
...
<p class="box bg-info">
  ...
  Those classes and samples have been translated into TypeScript, available at <code>../extensionsJSM/</code>,
  as ES6 modules -- these use the <code>../release/go-module.js</code> library.
...
<p class="box bg-info">
  ...
  TypeScript versions of those classes and samples are available in <code>../extensionsJSM/</code>.
</p>
...
<p class="box bg-info">
  ...
  TypeScript versions of those classes are available in <code>../extensionsJSM/</code>.
</p>
...
<pre class="lang-js" id="tool"><code>
  ...
  tool.standardMouseSelect = function() {
    ...
    // otherwise, call the base (would be super in ES6) functionality
    go.ClickSelectingTool.prototype.standardMouseSelect.call(tool);
  }
...
<p>
  In modern JavaScript (ECMAScript 6) or in TypeScript, you can use newer syntax for defining classes:
</p>
<pre class="lang-js"><code>

...
<script id="code">
  ...
  <div id="sample">
    ...
    <p>
      ...
      Reshape handles are drawn as Adornments at each point in the geometry. It is defined in its own file, as <a href="GeometryReshapingTool.ts" target="_blank">GeometryReshapingTool.ts</a>.
    </p>
    <p>

...
<script id="code">
  function init() {
    require(["ScrollingTableScript", "ScrollingTable"], function(app) {
      app.init();
    });
  }
  window.addEventListener('DOMContentLoaded', init);
	...
	<div id="sample">
		...
		<p>
      This makes use of the "ScrollingTable" Panel defined in <a href="ScrollingTable.ts" target="_blank">ScrollingTable.ts</a>.

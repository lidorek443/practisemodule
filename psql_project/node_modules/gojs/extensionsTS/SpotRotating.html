...
<script id="code">
  function init() {
    require(["SpotRotatingScript"], function(app) {
      app.init();
    });
  }
...
<div id="sample">
  ...
  <p>
    This extension tool is defined in its own file, as <a href="SpotRotatingTool.ts" target="_blank">SpotRotatingTool.ts</a>.
  </p>

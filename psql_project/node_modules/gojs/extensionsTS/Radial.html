...
<script id="code">
  function init() {
    require(["RadialScript"], function (app) {
      app.init();
      document.getElementById("setMaxLayersButton").onclick = app.adjustMaxLayers;
    });
  }
  ...
  <div id="sample">
    ...
    <p>
      The <code>RadialLayout</code> class is an extension defined at <a href="../extensionsJSM/RadialLayout.ts" target="_blank">RadialLayout.ts</a>.

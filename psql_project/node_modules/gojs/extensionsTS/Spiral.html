...
<meta name="description" content="TypeScript: A custom layout that arranges a chain of nodes in a spiral manner."/> 
...
<script id="code">
  ...
  <div id="sample">
    ...
    <p>
      ...
      is defined in its own file, as <a href="SpiralLayout.ts" target="_blank">SpiralLayout.ts</a>.
    </p>
  </div>
    </div>
    <!-- * * * * * * * * * * * * * -->

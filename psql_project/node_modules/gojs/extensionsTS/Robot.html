...
<script id="code">
  function init() {
    require(["RobotScript"], function(app) {
      ...
      document.getElementById("pan").onclick = app.pan;
    });
  }
  ...
  <div id="sample">
    ...
    <p>
      To simulate mouse events the buttons below use the <b>Robot</b> class that is defined in <a href="Robot.ts" target="_blank">Robot.ts</a>.
    </p>
    <p>
    ...
    <p>Panning operation:<br />
      <button id="pan">Pan the Diagram</button><br />
    </p>
    <p>

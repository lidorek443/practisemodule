...
<script id="code">
  function init() {
    require(["SectorReshapingScript"], function(app) {
      app.init();
    });
  }
  ...
  <div id="sample">
    ...
    <p>
      This extension tool is defined in its own file, as <a href="SectorReshapingTool.ts" target="_blank">SectorReshapingTool.ts</a>.
    </p>
  </div>
    </div>
    <!-- * * * * * * * * * * * * * -->

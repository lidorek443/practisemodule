...
<script id="code">
  ...
  <div id="sample">
    ...
    <p>
      This sample demonstrates the FreehandDrawingTool. It is defined in its own file, as <a href="FreehandDrawingTool.ts" target="_blank">FreehandDrawingTool.ts</a>.
      It also demonstrates the GeometryReshapingTool, another custom tool, defined in <a href="GeometryReshapingTool.ts" target="_blank">GeometryReshapingTool.ts</a>.
    </p>
    <p>

...
<script id="code">
  function init() {
    require(["ParallelRouteScript"], function(app) {
      app.init();
    });
  }
  ...
  <div id="sample">
    ...
    <p>
      This Link extension is defined in its own file, as <a href="ParallelRouteLink.ts" target="_blank">ParallelRouteLink.ts</a>.
    </p>
    </div>
    </div>
    <!-- * * * * * * * * * * * * * -->

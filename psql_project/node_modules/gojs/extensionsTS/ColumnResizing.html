...
<script id="code">
  ...
  <div id="sample">
    ...
    <p>
      This makes use of two tools, defined in their own files: <a href="ColumnResizingTool.ts" target="_blank">ColumnResizingTool.ts</a> and <a href="RowResizingTool.ts" target="_blank">RowResizingTool.ts</a>.

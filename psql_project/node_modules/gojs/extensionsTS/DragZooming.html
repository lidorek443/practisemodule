...
<script id="code">
  ...
  <div id="sample">
    ...
    <p>
      This sample demonstrates the DragZoomingTool, which replaces the standard DragSelectingTool. It is defined in its own file, as <a href="DragZoomingTool.ts" target="_blank">DragZoomingTool.ts</a>.
    </p>
    <p>

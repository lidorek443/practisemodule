...
<meta name="description" content="TypeScript: Allow the user to shift the label of a node."/> 
...
<script id="code">
  function init() {
    require(["NodeLabelDraggingScript"], function(app) {
      app.init();
  ...
  <div id="sample">
    ...
    <p>
      ...
      that makes use of the NodeLabelDraggingTool that is defined in its own file, as <a href="NodeLabelDraggingTool.ts" target="_blank">NodeLabelDraggingTool.ts</a>.
    </p>
    <p>
